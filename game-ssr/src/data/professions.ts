...
export const DREAMS = [
  { id: 'financial_independence', name: 'Финансовая независимость', icon: '💰', description: 'Достичь финансовой свободы и независимости' },
  { id: 'own_business', name: 'Собственный бизнес', icon: '🏢', description: 'Создать и развить собственное дело' },
  { id: 'investment_portfolio', name: 'Инвестиционный портфель', icon: '📈', description: 'Построить диверсифицированный инвестиционный портфель' },
  { id: 'passive_income', name: 'Пассивный доход', icon: '💎', description: 'Создать источники пассивного дохода' },
  { id: 'international_career', name: 'Международная карьера', icon: '🌍', description: 'Построить карьеру на международном уровне' },
  { id: 'education_center', name: 'Образовательный центр', icon: '🎓', description: 'Открыть образовательный центр или школу' },
  { id: 'charity_fund', name: 'Благотворительный фонд', icon: '❤️', description: 'Создать благотворительный фонд для помощи людям' },
  { id: 'tech_startup', name: 'Технологический стартап', icon: '🚀', description: 'Разработать инновационный технологический продукт' }
];
