...
export class ProfessionUtils {
   ...
   */
  static getRandomProfession(availableIds) {
   ...
   */
  static getProfessionsByIds(ids) {
   ...
   */
  static isProfessionAvailable(professionId, availableIds) {
   ...
   */
  static getProfessionsForSelection(roomMaxPlayers) {
   ...
   */
  static validateProfessionSelection(professionId, availableProfessions, selectedProfessions) {
   ...
   */
  static applySpecialAbilities(player, abilities) {
