...
import HallOfFameModel from '../models/HallOfFameModel.js';
...
class DatabaseService {
   ...
   */
  async updatePlayerInRoom(roomId, socketId, updateData) {
    try {
      const room = await RoomModel.findRoomById(roomId);
      if (!room) {
        return null;
   ...
   */
  async getPlayerRank(username, sortBy = 'points') {
    try {
...
// Экспортируем класс и singleton
