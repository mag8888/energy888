...
```javascript
{
  ...
  maxPlayers: Number,            // Максимум игроков (2-6)
...
4. Добавление в кэш для быстрого доступа
5. Уведомление всех клиентов об обновлении
6. Автоматическое присоединение создателя к комнате
...
### 12.4 Этап 4: Развертывание (1 день)
...
- ✅ Создание комнат работает стабильно
